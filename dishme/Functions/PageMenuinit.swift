...
protocol PageMenuViewDelegateinit: class {
...
class PageMenuViewinit: UIView {
    
    var delegate: PageMenuViewDelegateinit?
...
extension PageMenuViewinit: UIScrollViewDelegate {
...
extension PageMenuViewinit: UICollectionViewDelegate, UICollectionViewDataSource {
