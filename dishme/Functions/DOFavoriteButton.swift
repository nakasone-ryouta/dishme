...
public class DOFavoriteButton: UIButton {
    ...
    @IBInspectable public var imageColorOff: UIColor! = UIColor(red: 255/255, green: 255/255, blue: 255/255, alpha: 1.0) {
        didSet {
            if (!isSelected) {
    ...
    private func createLayers(image: UIImage!) {
        ...
        let lineFrame = CGRect(x: imageFrame.origin.x - imageFrame.width / 4,
                               y: imageFrame.origin.y - imageFrame.height / 4, width: imageFrame.width * 1.5,
